...
@section('title', 'Create Centre Onboard')
...
<h3 class="text-themecolor">Create Centre Onboard</h3>
@endsection
                ...
                <div class="card-body">
                    <form id="frmCenter" action="{{ url("bbadmin/centre-onboard/store") }}" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="form-group">
                            <h5>Url</h5>
                            <div class="controls">
                                <input type="text" id="url" name="url" class="form-control" value="" /> </div>
                        </div>
                        <div class="form-group">
                            <h5>Location <span class="text-danger">*</span></h5>
                            <div class="controls">
                                <input type="text" id="location" name="location" class="form-control" required data-validation-required-message="This field is required" /> </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
