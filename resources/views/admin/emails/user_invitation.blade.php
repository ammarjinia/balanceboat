                                                ...
                                                <tr>
                                                    <td height="25" valign="middle" align="left">
                                                        ...
                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="34" valign="middle" align="center" class="center-stack"  style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:14px; text-transform:uppercase; padding-top:10px; padding-bottom:10px"><a href="https://balanceboat.com"><h3>Balanceboat</h3></a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Logo -->
                                                ...
                                                <tr>
                                                    <td align="center">	
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e04f67" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:14px; text-transform:uppercase; padding-top:10px; padding-bottom:10px">Greetings from Balanceboat.</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        ...
                                                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <p>You have been given access to manage your listing at BalanceBoat. Please update the information as required. Once you update the information it will be reviewed by the "administrator" after which the updated information will be displayed. Should you have any questions or concerns, please do not hesitate to contact us. </p>
                                                                                                        <h3>User Information</h3>
                                                                                                        <table width="100%" border="1" cellspacing="0" cellpadding="8" style="margin-top:3px">
                                                                                                            <tr>
                                                                                                                <th align="left" width="20%" class="font_fix">
                                                                                                                    Name
                                                                                                                </th>
                                                                                                                <td align="left" width="80%" class="font_fix">
                                                                                                                    {{ @$userinfo->first_name." ".@$userinfo->last_name }}
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <th align="left" class="font_fix">
                                                                                                                    Email
                                                                                                                </th>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <th colspan="2" align="left" class="font_fix">
                                                                                                                    <a href="https://balanceboat.com/login" style="padding: 10px;background: #666;display: inline-block;color: #fff;">Login Now</a>
                                                                                                                </th>
                                                                                                            </tr>
                                                                                                        </table>                                                                                                        
                                                                                                        <p><br/></p>
                                                                    ...
                                                                    <td valign="top" align="center">
                                                                        ...
                                                                        <table align="center" cellspacing="0" cellpadding="0" border="0" class="full-width" width="100%">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="font_fix" style="font-size:12px; font-family: 'Montserrat', sans-serif; line-height:14px; color:#ffffff; font-weight:bold; padding-top:5px" align="center"><a href="mailto:zen@balanceboat.com" style="color:#ffffff;text-decoration:none !important;">zen@balanceboat.com</a> - <a href="http://balanceboat.com" style="color:#ffffff;text-decoration:none !important; ">www.balanceboat.com</a></td>
                                                                                </tr>                                                                                
                                                                                <tr>
                                                                                    <td height="20">&nbsp;</td>
                                                                                </tr>
                                                ...
                                                <tr>	
                                                    <td align="center">														
                                                        ...
                                                        <table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px"><strong>Copyright © 2020 Balanceboat.</strong><br /></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Space -->
