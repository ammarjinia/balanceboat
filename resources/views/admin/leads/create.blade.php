...
<h3 class="text-themecolor">Create Lead</h3>
@endsection
                    ...
                    <form id="frmLead" action="{{ url("bbadmin/lead/store") }}" method="post" enctype="multipart/form-data" novalidate>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="name" name="name" value="{!! old('name') !!}" class="form-control" required data-validation-required-message="This field is required" />
                                    </div>
                                </div>    
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="email" id="email" name="email" value="{!! old('email') !!}" class="form-control" required email data-validation-required-message="This field is required" />
                                    </div>
                                </div>    
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <h5>Ref. Url</h5>
                                    <div class="controls">
                                        <input type="text" id="ref_url" name="ref_url" value="{!! old('ref_url') !!}" class="form-control" />
                                    </div>
                                </div>    
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <h5>Message</h5>
                                    <div class="controls">
                                        <textarea id="message" name="message" rows="6" class="form-control">{!! old('message') !!}</textarea>    
                                    </div>
                                </div>    
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="whatsapp_verified" name="whatsapp_verified" value="1" {{ old('whatsapp_verified') == 1 ? 'checked' : '' }} />
                                <label class="form-check-label" for="whatsapp_verified">Whatsapp Verified</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="checkbox" id="instagram_verified" name="instagram_verified" value="1" {{ old('instagram_verified') == 1 ? 'checked' : '' }} />
...
@endsection
@section('footer')
<script src="{{ asset('admin/js/deal-create.js?v=3.3.2') }}"></script>
@endsection
