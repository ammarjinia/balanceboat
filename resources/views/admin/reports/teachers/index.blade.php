...
<h3 class="text-themecolor">Teachers Report</h3>
@endsection
    ...
    <div class="row">
        <div class="col-6">
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form id="frmCenter" action="{{ url("bbadmin/report/generate-teachers-report") }}" method="get" enctype="multipart/form-data" novalidate>
                        {{ csrf_field() }}
