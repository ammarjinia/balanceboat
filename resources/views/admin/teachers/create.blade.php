                ...
                <div class="card-body">
                    <form id="frmTeacher" action="{{ url("bbadmin/teachers/store") }}" method="post" enctype="multipart/form-data" novalidate >
                        ...
                        <div class="form-group">
                            <h5>Complete Bio</h5>
                            <div class="controls">
                                <textarea id="complete_bio" name="complete_bio" class="textarea_editor form-control" rows="15" placeholder="Enter text ..."></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <h5>Profile Image</h5>
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <textarea id="currently_working_with" name="currently_working_with" class="textarea_editor form-control" rows="15" placeholder="Enter text ..."></textarea>
                            </div>
                        </div>
