...
<head>
    ...
    <title>Reset Password — BalanceBoat Center</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="w-full max-w-md space-y-8">
            ...
            <div class="glass-premium p-8 rounded-3xl shadow-xl space-y-6 relative border border-white glow-ai">
                <div class="space-y-1">
                    <h2 class="text-xl font-serif font-bold text-slate-900">Choose a New Password</h2>
                    <p class="text-xs text-slate-500">Set a new password for your Center Owner account.</p>
                </div>
                ...
                <form method="POST" action="{{ route('center-panel.password.update') }}" class="space-y-4">
                    @csrf
                    ...
                    <div class="space-y-1">
                        <label for="password" class="block text-[10px] font-bold uppercase tracking-wider text-slate-400">New Password</label>
                        <input
                            type="password"
                            id="password"
                            name="password"
                    ...
                    <div class="space-y-1">
                        <label for="password_confirmation" class="block text-[10px] font-bold uppercase tracking-wider text-slate-400">Confirm New Password</label>
                        <input
                            type="password"
                            ...
                            required
                            minlength="8"
                            class="w-full p-3 bg-white/80 border border-slate-200 rounded-xl text-xs focus:ring-2 focus:ring-purple-500/20 focus:border-purple-500 outline-none transition-all font-mono"
