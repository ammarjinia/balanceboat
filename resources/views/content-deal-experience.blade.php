    ...
    <div class="row">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2">
            <div class="price_list" style="margin-top:10px;height:210px;">
                    <?php /*<small class="hidden-xs hidden-sm" style="color:#484848;font-size:14px;margin-bottom:5px;">{!! @$experience->final_room_price ? "Avg. Daily Price  " : "" !!}</small>*/?>
                    <small class="" style="color:#484848;font-size:11px;margin:0px;">{!! @$experience->min_duration_price ? "Starting From  " : "" !!}</small>
                    <span class="">
                        <?php
                        ...
                        <?php */?>
                        {!! @$experience->min_duration_price ? (\App\Http\Helpers\CommonHelper::get_currency_rate(@$experience->min_duration_price, \App\Http\Helpers\CommonHelper::get_site_currency())) : null !!}
                    </span>
                    <?php
                    ...
                    ?>
                    <a href="#mdlInquiry" data-toggle="modal" target="_blank" class="btn btn_2 btn-block text-center btn-send-inquiry" data-exp-name="{{ $experience->name }}" data-exp-id="{{ $experience->id }}" style="padding:7px 10px;white-space:break-spaces;margin-top:10px;">Inquire</a>
                    ...
                    ?>
                    @endif
                    <a href="{{ url("/experience/".$experience->slug) }}" id="btnListReserve{{ @$experience->id }}" class="btn btn_1 btn-block btn-reservation" data-exp-name="{{ $experience->name }}" data-exp-id="{{ $experience->id }}" style="padding:7px 10px;white-space:break-spaces;">Reserve</a>
            </div>
            @if (!empty(@$discount)) 
