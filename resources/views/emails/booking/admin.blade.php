                            ...
                            <tbody>
                                <tr>
                                    <td valign="top" bgcolor="#ffffff" align="center">
                                                ...
                                                <tr>
                                                    <td height="25" valign="middle" align="left">
                                                        ...
                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="34" valign="middle" align="center" class="center-stack"  style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:14px; text-transform:uppercase; padding-top:10px; padding-bottom:10px">
                                                                        <a href="htps://balanceboat.com">
                                                                            <img src="{{ url('public/basicfront/img/balanceboat-header-logo.png') }}" alt="Balanceboat" />
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                ...
                                                <tr>
                                                    <td align="center"> 
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; text-transform:uppercase; padding-top:10px; padding-bottom:10px">Booking Information</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        ...
                                                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <table width="100%" border="1" cellspacing="0" cellpadding="8" style="margin-top:30px">
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td>{{ $booking->pay_amount." ".$booking->currency }}</td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <strong>Days</strong>
                                        ...
                                        </table> <!-- End footer ==================--><a!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
