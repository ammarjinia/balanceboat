...
<html xmlns:v="urn:schemas-microsoft-com:vml">
    <head>
        ...
        <title>Balanceboat | Contact Us</title>
        <style type="text/css">
                                                ...
                                                <tr>
                                                    <td height="25" valign="middle" align="left">
                                                        ...
                                                        <table width="100%" align="center" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="34" valign="middle" align="center" class="center-stack" ><a href="#"><img src="{{ url("/public/basicfront/img/balanceboat-header-logo.png") }}" alt="Balanceboat" /></a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Logo -->
                                                ...
                                                <tr>
                                                    <td align="center">	
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; text-transform:uppercase; padding:3px;"></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                        <td class="font_fix" style="font-size:12px; font-family: 'Montserrat', sans-serif; line-height:14px; color:#ffffff; font-weight:bold; padding-top:5px" align="center">
                                                                                            <a href="https://www.facebook.com/balanceboat"><img src="https://codetwocdn.azureedge.net/images/mail-signatures/generator/compact-logo/fb.png" width="23" height="23" /></a>
                                                                                            &nbsp;
                                                                                            <a href="https://www.instagram.com/thebalanceboat"><img src="https://codetwocdn.azureedge.net/images/mail-signatures/generator/compact-logo/it.png" width="23" height="23" /></a>
                                                                                        </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td height="20">&nbsp;</td>
