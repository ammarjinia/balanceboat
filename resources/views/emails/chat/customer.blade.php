                                                ...
                                                <tr>
                                                    <td height="25" valign="middle" align="left">
                                                        ...
                                                        <table width="160" align="left" cellspacing="0" cellpadding="0" border="0" class="full-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td height="34" valign="middle" align="center" class="center-stack"  style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:14px; text-transform:uppercase; padding-top:10px; padding-bottom:10px"><a href="htps://balanceboat.com"><h3>Balanceboat</h3></a></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Logo -->
                                                ...
                                                <tr>
                                                    <td align="center"> 
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; text-transform:uppercase; padding-top:10px; padding-bottom:10px">Greetings</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        ...
                                                                                                        <tbody>
                                                                                                            <tr>
                                                                                                                <td>Hello <?php echo strstr("@$email","@",true);?>,</td>
                                                                                                            </tr>    
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    <p>Thank you for contacting BalanceBoat team.</p>
                                                                                                                    <p>One of our executive will get back to you soon.</p>
                                                                                                                    <p>Please review the message you have sent.</p>
                                                                                                                    <h4 style="margin-bottom:5px;">Message</h4>
                                                                                                                    <p>{{ @$bodymessage }}</p>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td><p style="margin-top:10px;margin-bottom:10px">In case of any query please do not hesitate to contact us on <a href="mailto:zen@balanceboat.com">zen@balanceboat.com</a> or whatsapp us on <a href="tel:917408846000">+91-7408846000</a></p>
                                                                                                            </td>
                                                                                                            </tr>
                                                                                                        </tbody>
                                                                                                        <tfoot>
                                                                                                            <tr>
                                                                                                                <td>
                                                                                                                    ...
                                                                                                                    <strong>BalanceBoat Team</strong>
                                                                                                                </td>
                                                                                                            </tr>
                                                                                                        </tfoot>
                                                                                                        </table>
