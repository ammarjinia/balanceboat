                                                ...
                                                <tr>
                                                    <td align="center"> 
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; padding-top:10px; padding-bottom:10px">Information</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        ...
                                                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <p>Tour inquiry has been submitted to the centre. You will receive a notification once they respond. </p>
                                                                                                        <p>If you do not hear from the centre kindly contact <a href="mailto::zen@balanceboat.com">zen@balanceboat.com</a>.</p>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>                                                                        
