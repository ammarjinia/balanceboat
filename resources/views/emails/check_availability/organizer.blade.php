                                                ...
                                                <tr>
                                                    <td align="center"> 
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; padding-top:10px; padding-bottom:10px">New Customer Inquiry</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                        ...
                                                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                                                                        <p>
                                                                                                            A user has inquired for checking the availability of the retreat <strong>{!! $experience->name !!}</strong> on the date:
                                                                                                                <strong>{{ \Carbon\Carbon::parse($date)->format("d F, Y") }}</strong>.
                                                                                                            </p>

                                                                                                            <p>Please click the below links to confirm:</p>

                                                                                                            <a href="{{ route('check-availability.response', ['inquiry_id' => $inquiry_id, 'response' => 'yes']) }}"
                                                                                                            style="padding: 10px 20px; background-color: green; color: white; text-decoration: none; margin-right: 10px;">
                                                                                                            Yes
                                                                                                            </a>

                                                                                                            <a href="{{ route('check-availability.response', ['inquiry_id' => $inquiry_id, 'response' => 'no']) }}"
