                                                ...
                                                <tr>
                                                    <td align="center"> 
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; text-transform:uppercase; padding-top:10px; padding-bottom:10px">Ayurveda Lead</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                    ...
                                                                    <td align="left">
                                                                        ...
                                                                        <table width="550" bgcolor="#ffffff" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width" style="border-bottom:1px solid #ddd;">
                                                                            <tbody>
                                                                                ...
                                                                                <!-- End Space -->
                                                                                <tr>
                                                                                    <td align="left"><p>Below is the email and phone no. for Ayurveda lead.</p></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        <!-- Start Column 1 -->
