                                                ...
                                                <tr>
                                                    <td align="center"> 
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; padding-top:10px; padding-bottom:10px">Received Call Back Request with the following</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                                    ...
                                                                                    <td align="left">
                                                                                        ...
                                                                                        <table width="100%" align="left" cellspacing="0" cellpadding="0" border="0">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td>
                                                            <table width="100%" border="0" cellspacing="0" cellpadding="4" style="margin-top:3px">
                                                                ...
                                                                <tr>
                                                                 ...
                                                                 <tr>
                                                                    <th align="left" class="font_fix">
                                                                       <a href="{{ url("/customerinquiry/$conversation") }}">Click here to view message</a>
                                                                    </th>
                                                ...
                                                <tr>    
                                                    <td align="center">                                                     
                                                        ...
                                                        <table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px"><strong>Copyright © 2019 balanceboat</strong><br /></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Space -->
