                                                ...
                                                <tr>
                                                    <td align="center">	
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0" border="0" class="full-width" >
                                                            <tbody>
                                                                <tr>
                                                                    <td class="font_fix" align="center" bgcolor="#e45166" style="color:#ffffff;font-weight:bold; font-family: 'Montserrat', sans-serif; font-size:18px; text-transform:uppercase; padding-top:10px; padding-bottom:10px">Business Register Information</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                                    ...
                                                                    <td align="left">
                                                                        ...
                                                                        <table width="550" bgcolor="#ffffff" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width" style="border-bottom:1px solid #ddd;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        <p>Dear Sender: {{ @$business_name }}</p>
                                                                                        <p>Thank you for contacting BalanceBoat.</p>
                                                                                        <p>Our team shall get back to you shortly. In the meantime if you have any queries please contact us on <a href="mailto:zen@balanceboat.com">zen@balanceboat.com</a></p>
                                                                                    </td>
                                                                                </tr>
                                                                                <!-- Start Space -->
                                                                                <tr>
                                                ...
                                                <tr>	
                                                    <td align="center">														
                                                        ...
                                                        <table width="550" align="center" cellspacing="0" cellpadding="0" border="0" class="content-width">
                                                            <tbody>
                                                                <tr>
                                                                    <td  align="center" valign="middle" style="font-family: Arial, Helvetica, sans-serif;font-size:11px; font-weight:normal; color:#cccccc; padding-top:10px; padding-bottom:10px"><strong>Copyright © 2018 balanceboat</strong><br /></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <!-- End Space -->
