...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>{{ config('app.name', 'Balanceboat') }}</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        ...
        <script src="{{ asset('public/admin/plugins/bootstrap/js/popper.min.js') }}"></script>
        ...
        <!--stickey kit -->
        <script src="{{ asset('public/admin/plugins/sticky-kit-master/dist/sticky-kit.min.js') }}"></script>
        ...
        <!-- Style switcher -->
        <!-- ============================================================== -->
        <script src="{{ asset('public/admin/plugins/styleswitcher/jQuery.style.switcher.js') }}"></script>
        <!-- Scripts -->
    </body>
</html>
