...
<html lang="{{ config('app.locale')}}">
    ...
    <link rel="stylesheet" href="{{ url('blog_assets/css/style.css?v=1.42') }}">
@yield('head')
    ...
    <div class="main-wrapper">
            ...
            <div class="header-wrap">
                <div class="row justify-content-between align-items-center">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-3 col-12">
                        <div class="logo">
                            <a href="{{ url("/") }}"><h4 class="m-0">Balance<span>Boat</span></h4></a>
                        </div>
                    </div>
        ...
        <section class="marquee-slider">
            <div class="position-relative marquee-container d-none d-sm-block">
                <?php foreach (@$objMarquee as $marquee) { ?>
                <div class="marquee">
                    <a class="c-white" href="<?php if(@$marquee->url){ echo $marquee->url; }else{ echo '#'; } ?>">{!! @$marquee->content !!}</a>
                </div>
        ...
        @endif
        <section>
            <a href="{{ url('/') }}">Home</a> > <a href="{{ url('/blog') }}">Blog</a> > {!! @$blog->name !!} 
        </section>
          @yield('content')
        <!-- Start Footer Area  -->
...
============================================ -->
    ...
    <script>
        $(document).ready(function() {
            // Banner Advertisement Close
            $('.banner-ad .close').on('click', function () {
              $('.banner-ad').addClass('d-none');
            });
        });
    </script>
    @yield('footer')
