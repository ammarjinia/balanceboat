...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('public/deals/css/bootstrap-grid.min.css?v=1.8.2') }}" />
        <link rel="stylesheet" href="{{ asset('public/deals/css/styles.css?v=1.8.2') }}" />
        ...
        <link rel="stylesheet" href="{{ asset('public/deals/css/bootstrap-grid.min.css?v=1') }}" />
        <link rel="stylesheet" href="{{ asset('public/deals/css/styles.css?v=1') }}" />
        <link rel="icon" href="{{ asset('public/deals/images/favicon.png') }}" type="image/png" sizes="16x16" />
    ...
    <body class="interactive-list deal-page">
        <header>
            <div class="top">
                <div class="container">
                    <div class="row bg-header">
                        ...
                        <div class="col col-lg-4 bg-header-right no-decoration-all ms-auto">
                            ...
                            <div data-popup="popup-call-back" class="show-bg-modal call-back">Request Call Back</div>
                        </div>
                    </div>
                </div>
            </div>
              ...
              <div class="col-12 col-lg-6">
                    ...
                    <ul>
                      <li>
                        <a href="javascript:void(0);"
                          ><i class="icon-location"></i> 68 Maqbara Road,
                          Hazratganj,<br />
                          Lucknow - 226001, India</a
                        >
                      </li>
                      <li>
                        <a href="tel:+917800080808" id="phone"
                          ><i class="icon-phone"></i> +91-7800080808</a
                        >
                      </li>
                      <li>
                        <a href="mailto:zen@balanceboat.com" id="email_footer"
                          ><span>&#9993;</span> zen@balanceboat.com</a
                        >
                      </li>
                    </ul>
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-12 c-white d-flex justify-content-end">
                    <a href="" data-popup="popup-call-back" class="show-bg-modal call-back">Request Call Back</a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="{{ asset('public/deals/js/script.js?v=2.1.283') }}"></script>
    <script src="{{asset('public/basicfront/js/merge.js?v=1')}}" ></script>
    <script src="{{asset('public/basicfront/js/jquery.validate.min.js') }}"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-cookie/1.4.1/jquery.cookie.min.js" crossorigin="anonymous"></script>
    <script src="{{ asset('public/basicfront/js/center-detail.js?v=7') }}"></script>
